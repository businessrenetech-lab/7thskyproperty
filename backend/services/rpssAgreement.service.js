...
const SCHED = require('./salesAgreementSchedules').sale;

const VERTICAL = 'sale_sale';
const CFG = { doc_no: 'SSPC-RPSS-01', version: '0.2', title: 'Residential Property Sale Service Agreement', party: 'Seller', clauses: CLAUSES, ...SCHED };
