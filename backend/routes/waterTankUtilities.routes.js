/**
 * waterTankUtilities.routes.js — Utility Bill & Connection Assistance register
 * (utility_coordination lines only; the controller refuses lines without it).
 */
const express = require('express');
const router = express.Router();
const { authMiddleware } = require('../middleware/auth.middleware');
const { canRead, canOperate, canBind } = require('../middleware/wtRoles');
const ctrl = require('../controllers/waterTankUtilities.controller');
