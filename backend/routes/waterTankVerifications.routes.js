/**
 * waterTankVerifications.routes.js — Verification Register (Property Documentation
 * & Verification line only; the controller refuses lines without verification_register).
 */
const express = require('express');
const router = express.Router();
const { authMiddleware } = require('../middleware/auth.middleware');
const { canRead, canOperate, canBind } = require('../middleware/wtRoles');
const ctrl = require('../controllers/waterTankVerifications.controller');
