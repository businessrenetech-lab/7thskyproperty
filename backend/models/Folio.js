...
const Folio = sequelize.define('Folio', {
  ...
  folio_type: { type: DataTypes.ENUM('tenant', 'landlord', 'provider'), allowNull: false },
  folio_scope: { type: DataTypes.ENUM('tenancy', 'landlord', 'landlord_property', 'provider'), allowNull: false },
