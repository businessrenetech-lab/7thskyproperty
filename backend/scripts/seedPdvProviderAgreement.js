/**
 * Seeds (or refreshes) the Property Documentation & Verification Services — Service
 * Delivery Provider Master Agreement (SSPC-PDVS-SDPMA-01 v0.2, Schedules A–D) for
 ...
 *   node scripts/seedPdvProviderAgreement.js
 */
require('dotenv').config();
const sequelize = require('../config/db.config');
const AgreementTemplate = require('../models/AgreementTemplate');

const NAME = 'Property Documentation & Verification Services — Service Provider Master Agreement';
const VERTICAL = 'property_documentation_verification';
...
const FIELDS = [
  ...
  CG('svc_verification', 'Property Documentation & Verification', 'Service Categories', ['Deed Verification', 'Chain of Ownership Verification', 'Title Review', 'Land Record Verification', 'Government Record Verification', 'Encumbrance Review', 'Due Diligence Review']),
  CG('svc_mutation', 'Mutation & Land Record Support', 'Service Categories', ['Mutation Documentation Review', 'Mutation Application Assistance', 'Land Record Correction', 'Government Liaison', 'Record Status Verification']),
  CG('svc_documentation', 'Documentation & Correspondence', 'Service Categories', ['Documentation Review', 'Correspondence Drafting', 'File Compilation', 'Record Management']),
  CG('svc_conveyancing', 'Conveyancing & Transfer', 'Service Categories', ['Transfer Documentation', 'Conveyancing Coordination', 'Sale & Purchase Review', 'Registration Coordination', 'Settlement Coordination']),
  CG('svc_nrb', 'NRB Documentation Support', 'Service Categories', ['Overseas Documentation', 'Remote Verification', 'Digital Documentation', 'Ownership Verification', 'Cross-Border Coordination']),
  ...
  CG('technical_licences', 'Professional Registrations / Memberships', 'Licences & Insurance', ['Bar Council Enrolment (Lawyer)', 'Conveyancer Registration', 'Land Consultant Credentials', 'Other Relevant Licences']),
...
const CONTENT_HTML = `
<h1 style="text-align:center">Property Documentation & Verification Services — Service Delivery Provider Master Agreement</h1>

<h3>1. Purpose</h3>
<p>This Agreement sets out the terms under which the Service Provider delivers Property Documentation &amp; Verification Services for clients referred by Seventh Sky. It establishes the Parties' responsibilities, service standards, commercial terms and legal obligations. Individual client engagements will be managed under separate Work Orders.</p>
...
<p><strong>A. Property Documentation &amp; Verification</strong></p>${V('svc_verification')}
<p><strong>B. Mutation &amp; Land Record Support</strong></p>${V('svc_mutation')}
<p><strong>C. Documentation &amp; Correspondence</strong></p>${V('svc_documentation')}
<p><strong>D. Conveyancing &amp; Transfer</strong></p>${V('svc_conveyancing')}
<p><strong>E. NRB Documentation Support</strong></p>${V('svc_nrb')}

<h3>5. Work Orders</h3>
<p>Each client engagement shall be managed under a separate Work Order issued by Seventh Sky, which may include client details, selected services, scope of work, required documentation, project timeline, agreed pricing, payment schedule and any special requirements. If a Work Order conflicts with this Agreement, the Work Order prevails for that specific engagement.</p>
...
<p><strong>The Service Provider</strong> is responsible for performing the contracted services professionally; supplying competent, qualified personnel; complying with all applicable laws and professional standards; maintaining all required licences, registrations and insurance; conducting verification and investigation activities diligently; ensuring the accuracy of findings and reports; rectifying deficient work; and completing work within agreed timeframes. The Service Provider remains solely responsible for the professional quality and accuracy of all verification work, findings and reports.</p>
...
<p>The Service Provider shall perform all Services with reasonable care, skill and diligence; using suitably qualified personnel; within the agreed timeframe; and in compliance with the relevant Work Order. The Service Provider shall conduct thorough document review, registry and land-office searches and record verification as required, identify material discrepancies and risks, protect client information, and promptly report delays or issues.</p>
...
<p>The Service Provider shall provide all documents reasonably required for the Services, including verification findings, search records, mutation review records, due diligence reports and recommendations. Business records relating to Services performed under this Agreement must be retained for at least seven (7) years, or longer where required by law.</p>
...
<p>Each Party is responsible for its own acts, omissions, negligence and breaches. The Service Provider shall be responsible for any loss, damage, claim or expense arising from deficient or inaccurate verification work, negligent acts or omissions, failure to comply with applicable laws, or breach of this Agreement, and shall indemnify Seventh Sky against claims, losses, damages, costs and liabilities arising from the Service Provider's negligence, misconduct or breach, except to the extent caused by Seventh Sky.</p>

<h3>14. Verification &amp; Records Disclaimer</h3>
<p>Verification findings are based on the documents and records reasonably available at the time of review. Government authorities remain responsible for official records, registrations and administrative decisions; courts and tribunals remain responsible for judicial decisions. Neither Seventh Sky nor the Service Provider warrants the accuracy or completeness of government records or third-party documents, and neither guarantees the outcome of any registration, mutation or transfer application.</p>

<h3>15. Confidentiality &amp; Data Protection</h3>
<p>Each Party shall keep confidential all non-public business, commercial and client property information obtained during this Agreement, use it only for the purposes of performing this Agreement, and not disclose it to any third party unless required by law, authorised in writing, or reasonably required to perform the Services. The Service Provider shall take reasonable measures to protect all client information. These obligations continue after termination.</p>
...
(async () => {
  try {
    ...
    const payload = {
      ...
      description: 'Property Documentation & Verification Services Service Provider Master Agreement (SSPC-PDVS-SDPMA-01 v0.2) — Schedules A–D, checkbox service/insurance selection + provider KYC intake.',
      content_html: CONTENT_HTML, fields: FIELDS, signers: SIGNERS,
      source_filename: 'Property Doc and Verification - Service Provider Master Agreement - V0.2.docx',
    };
