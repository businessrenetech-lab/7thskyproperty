...
mount('/api/business-inspections', './routes/businessInspection.routes');
mount('/api/business-offers', './routes/businessOffer.routes');
...
mount('/api/business-leases', './routes/businessLease.routes');
mount('/api/business-rent-collections', './routes/businessRentCollection.routes');
mount('/api/business-maintenance', './routes/businessMaintenance.routes');
mount('/api/business-registration-projects', './routes/businessRegistrationProject.routes');
...
mount('/api/wt-client-docs', './routes/waterTankClientDocs.routes');
mount('/api/wt-loan-applications', './routes/waterTankLoanApplications.routes');
mount('/api/wt-verifications', './routes/waterTankVerifications.routes');
mount('/api/wt-beneficiaries', './routes/waterTankBeneficiaries.routes');
mount('/api/wt-resources', './routes/waterTankResources.routes');
mount('/api/wt-inventory', './routes/waterTankInventory.routes');
mount('/api/wt-assets', './routes/waterTankAssets.routes');
mount('/api/wt-concierge', './routes/waterTankConcierge.routes');
mount('/api/wt-utilities', './routes/waterTankUtilities.routes');
mount('/api/public/doc-request', './routes/publicClientDocRequest.routes');
