...
const DEFAULT_SETTINGS = [
  ...
  { setting_key: 'SMTP_USER', setting_value: 'info@seventhskypropertycare.com', description: 'Primary Email (info@) — all general emails', is_secret: false, category: 'email' },
  { setting_key: 'SMTP_PASS', setting_value: '', description: 'Primary Email Password', is_secret: true, category: 'email' },
  { setting_key: 'SMTP_HR_USER', setting_value: 'hr@seventhskypropertycare.com', description: 'HR Email — job offers, payslips, staff emails', is_secret: false, category: 'email' },
  { setting_key: 'SMTP_HR_PASS', setting_value: '', description: 'HR Email Password', is_secret: true, category: 'email' },
  { setting_key: 'SMTP_SUPPORT_USER', setting_value: 'support@seventhskypropertycare.com', description: 'Support Email — client support and enquiries', is_secret: false, category: 'email' },
  { setting_key: 'SMTP_SUPPORT_PASS', setting_value: '', description: 'Support Email Password', is_secret: true, category: 'email' },
  { setting_key: 'ADMIN_NOTIFICATION_EMAILS', setting_value: 'info@seventhskypropertycare.com', description: 'Admin recipients for lead, client request, and monthly report emails', is_secret: false, category: 'email' },
  ...
  // ── SEO & Meta ──────────────────────────────────────────
  { setting_key: 'SEO_SITE_TITLE', setting_value: 'Seventh Sky Property Care', description: 'Default Site Title', is_secret: false, category: 'seo' },
  ...
  { setting_key: 'SOCIAL_FACEBOOK', setting_value: '', description: 'Facebook Page URL', is_secret: false, category: 'social' },
  { setting_key: 'SOCIAL_INSTAGRAM', setting_value: '', description: 'Instagram Profile URL', is_secret: false, category: 'social' },
  { setting_key: 'SOCIAL_YOUTUBE', setting_value: '', description: 'YouTube Channel URL', is_secret: false, category: 'social' },
  ...
  // ── Contact Information ─────────────────────────────────
  { setting_key: 'CONTACT_PHONE_PRIMARY', setting_value: '', description: 'Primary Phone Number', is_secret: false, category: 'contact' },
  { setting_key: 'CONTACT_PHONE_SECONDARY', setting_value: '', description: 'Secondary Phone Number', is_secret: false, category: 'contact' },
  { setting_key: 'CONTACT_WHATSAPP', setting_value: '', description: 'WhatsApp Business Number', is_secret: false, category: 'contact' },
  { setting_key: 'CONTACT_EMAIL_PRIMARY', setting_value: 'info@seventhskypropertycare.com', description: 'Primary Contact Email', is_secret: false, category: 'contact' },
  { setting_key: 'CONTACT_EMAIL_SUPPORT', setting_value: 'support@seventhskypropertycare.com', description: 'Support Email Address', is_secret: false, category: 'contact' },
  { setting_key: 'CONTACT_ADDRESS', setting_value: '', description: 'Business Address', is_secret: false, category: 'contact' },
  ...
  { setting_key: 'BRAND_PRIMARY_COLOR', setting_value: '#1bbdf1', description: 'Primary Brand Color (hex)', is_secret: false, category: 'branding' },
  { setting_key: 'BRAND_ACCENT_COLOR', setting_value: '#003768', description: 'Accent Brand Color (hex)', is_secret: false, category: 'branding' },
  ...
  // ── Payment Settings ─────────────────────────────────────
  { setting_key: 'BKASH_MERCHANT_NO', setting_value: '', description: 'bKash Merchant Number', is_secret: false, category: 'payment' },
