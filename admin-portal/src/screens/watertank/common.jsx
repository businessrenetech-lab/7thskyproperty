...
export const SERVICE_UI = {
  ...
  '/fitness-room-interior-design': {
    ...
    short: 'Fitness Room',
    doc_code: 'FRIDS', // SSPC-FRIDS-… document numbers
    internal_team: true, // Seventh Sky coordinates in-house; no external provider
    wo_consumables_label: 'Equipment, Finishes & Consumables',
    accent: '#dc2626', accent_ink: '#991b1b', accent_soft: '#fee2e2', // portal theming (red)
    equipment: {
    ...
    // SOP Phase 1 — Consultation & Fitness Room Design Assessment + site
    // inspection. Profile is the space & brief; "quality" is the design
    // assessment; readings are site measurements (area, ceiling height, floor load).
    assess: {
      profile_label: 'Space & brief', profile_hint: 'Facility type, style, scope',
      quality_label: 'Design assessment', quality_hint: 'Feasibility & requirements',
      obs1_label: 'Design observations', obs1_ph: 'Equipment layout, traffic flow, ventilation, lighting…',
      obs2_label: 'Constraints / risks', obs2_ph: 'Floor load, low ceiling, noise, structural walls, building rules…',
      readings_label: 'On-site measurements',
      readings: [
        { key: 'total_area', ph: 'Total area (sq ft)' }, { key: 'ceiling_height', ph: 'Ceiling height (ft)' },
        { key: 'zones', ph: 'Number of zones / areas' }, { key: 'budget', ph: 'Indicative budget (৳)' },
        { key: 'timeline', ph: 'Target timeline (weeks)' },
      ],
    },
    report_types: ['Site Visit', 'Design Concept', 'Progress', 'Handover', 'Completion Sign-Off'],
    report_placeholder: 'e.g. Completed the consultation and site measurement, agreed the equipment layout and concept, and prepared the fitness space plan for client approval.',
    registers: {
      incident_types: ['Property Damage', 'Injury', 'Fire', 'Electrical Incident', 'Water Damage', 'Equipment Failure', 'Other'],
      warranty_hint: 'e.g. Design Services, Workmanship, Installation, Equipment Installation.',
      location_placeholder: 'Room / area of the fitness facility…',
      incident_blurb: 'Property damage, injury, electrical/water damage or equipment failure during the works',
      warranty_scope: 'completed design, fit-out, installation and equipment installation work',
      incident_log: 'property damage, injuries, electrical/water damage and equipment failures',
      direct_cost_examples: 'Fitness equipment, gym flooring, mirrors, materials, transport, day labour and permits',
    },
  },
  '/commercial-interior-design': {
    ...
    short: 'Commercial',
    doc_code: 'CIDS', // SSPC-CIDS-… document numbers
    internal_team: true, // Seventh Sky coordinates in-house; no external provider
    wo_consumables_label: 'Materials, Furniture & Consumables',
    accent: '#1d4ed8', accent_ink: '#1e3a8a', accent_soft: '#dbeafe', // portal theming (blue)
    equipment: {
    ...
    assess: {
      profile_label: 'Space & brief', profile_hint: 'Business, style, scope',
      quality_label: 'Design assessment', quality_hint: 'Feasibility & requirements',
      obs1_label: 'Design observations', obs1_ph: 'Space planning, workflow, branding, lighting, MEP…',
      obs2_label: 'Constraints / risks', obs2_ph: 'Landlord rules, fire code, structural walls, occupancy limits…',
      readings_label: 'On-site measurements',
      readings: [
        { key: 'total_area', ph: 'Total area (sq ft)' }, { key: 'floors', ph: 'Number of floors / zones' },
        { key: 'occupancy', ph: 'Occupancy / seat count' }, { key: 'budget', ph: 'Indicative budget (৳)' },
        { key: 'timeline', ph: 'Target timeline (weeks)' },
      ],
    },
    report_types: ['Site Visit', 'Design Concept', 'Progress', 'Handover', 'Completion Sign-Off'],
    report_placeholder: 'e.g. Completed the consultation and site survey, agreed the space plan and concept, and prepared the fit-out scope for client approval.',
    registers: {
      incident_types: ['Property Damage', 'Injury', 'Fire', 'Electrical Incident', 'Water Damage', 'Material Defect', 'Other'],
      warranty_hint: 'e.g. Design Services, Workmanship, Installation, Furniture.',
      location_placeholder: 'Floor / area of the premises…',
      incident_blurb: 'Property damage, injury, electrical or water damage during the works',
      warranty_scope: 'completed design, fit-out, renovation and furniture installation work',
      incident_log: 'property damage, injuries, electrical/water damage and material defects',
  ...
  '/furniture-styling-consultation': {
    label: 'Furniture & Styling Consultation',
    full_label: 'Furniture & Styling Consultation',
    short: 'Furniture & Styling',
    doc_code: 'FSCS', // SSPC-FSCS-… document numbers
    internal_team: true, // Seventh Sky coordinates in-house; no external provider
    wo_consumables_label: 'Furniture, Decor & Consumables',
    accent: '#c026d3', accent_ink: '#86198f', accent_soft: '#fae8ff', // portal theming (fuchsia)
    equipment: {
    ...
    assess: {
      profile_label: 'Space & brief', profile_hint: 'Property, theme, scope',
      quality_label: 'Styling assessment', quality_hint: 'Layout, light & scope',
      obs1_label: 'Styling observations', obs1_ph: 'Furniture layout, focal points, colour, existing pieces…',
      obs2_label: 'Constraints / risks', obs2_ph: 'Delivery access, lead times, budget limits, retained items…',
      readings_label: 'On-site measurements',
      readings: [
        { key: 'total_area', ph: 'Total area (sq ft)' }, { key: 'rooms', ph: 'Number of rooms / zones' },
        { key: 'pieces', ph: 'Approx. furniture pieces' }, { key: 'budget', ph: 'Indicative budget (৳)' },
        { key: 'timeline', ph: 'Target timeline (weeks)' },
      ],
    },
    report_types: ['Site Visit', 'Styling Concept', 'Progress', 'Handover', 'Completion Sign-Off'],
    report_placeholder: 'e.g. Completed the styling consultation and site measurement, agreed the theme and furniture selections, and prepared the procurement list for client approval.',
    registers: {
      incident_types: ['Furniture Damage', 'Property Damage', 'Injury', 'Water Damage', 'Wrong Item Supplied', 'Other'],
      warranty_hint: 'e.g. Consultation, Styling, Furniture Installation, Custom Furniture.',
      location_placeholder: 'Room / area of the property…',
      incident_blurb: 'Furniture or property damage during delivery, installation or styling',
      warranty_scope: 'completed consultation, styling, furniture and custom furniture installation',
      incident_log: 'furniture damage, property damage, injuries and wrong items supplied',
