        ...
        <div className="pm-col st-workspace">
          {!transaction ? (
            ...
            <Panel
              icon={Scale}
              heading="Settlement"
              sub="Money in, money out, bank matching and completion now live in the Settlement Desk."
            >
              <div
              ...
              >
                <div>
                  <div className="cell-sub">Settlement</div>
                  <strong>{settlement ? title(settlement.status) : "Not started"}</strong>
                </div>
                {nextActionLabel && (
                  <div>
                    <div className="cell-sub">Next</div>
                    <strong>{nextActionLabel}</strong>
                  </div>
                )}
                {blockers.length > 0 && (
                  <div>
                    <div className="cell-sub">Blockers</div>
              ...
              <Button
                icon={Scale}
                onClick={() => navigate(settlementDeskPath(property.category, propertyId))}
              >
