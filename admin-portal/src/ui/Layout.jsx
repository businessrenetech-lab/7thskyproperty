...
const NAV = [
  ...
  { key: 'pm', label: 'Property Management', icon: KeyRound, children: [
    ...
    { to: '/property-management/rentals', label: 'Rentals' },
    { to: '/property-management/applications', label: 'Tenant Applications' },
    { to: '/property-management/enquiries', label: 'Enquiries' },
    ...
    { to: '/compliance?listing_type=rent', label: 'Compliance' },
    { to: '/projects?vertical_key=leasing,short_stay', label: 'Checklists / Workflows' },
  ] },
...
const TITLES = {
  ...
  '/property-management/applications': 'Tenant Applications', '/property-management/enquiries': 'Rental Enquiries', '/property-management/assessments': 'Rental Assessments', '/property-management/statements': 'Owner Statements', '/property-management/renewals': 'Renewals', '/property-management/vacancies': 'Vacancy Notices', '/property-management/settlements': 'Deposit Settlements', '/property-management/utilities': 'Utilities & Bills', '/property-management/tenant-requests': 'Tenant Requests', '/property-management/arrears': 'Arrears Actions', '/property-management/marketing': 'Rental Marketing', '/property-management/expense-approvals': 'Expense Approvals', '/property-management/risks': 'Risk Register', '/property-management/reports': 'Rental Reports',
  '/commercial/buy': 'Commercial · Buy', '/commercial/sell': 'Commercial · Sell', '/services': 'Services',
  '/projects': 'Projects',
  '/work-orders': 'Work Orders', '/inspections': 'Inspections',
  '/contacts': 'Contacts', '/role-onboarding': 'Role Onboarding', '/clients': 'Clients', '/leads': 'Leads', '/providers': 'Providers',
  '/consultations': 'Consultations', '/compliance': 'Compliance',
  '/rural/buy': 'Rural · Buy', '/rural/sell': 'Rural · Sell',
  '/agreements': 'Agreements', '/documents': 'Documents', '/signing': 'eSign Envelopes',
