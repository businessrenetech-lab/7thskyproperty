const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/html2pdf-BmLNKVOg.js","assets/vendor-react-DPuOgitA.js"])))=>i.map(i=>d[i]);
import{_ as $}from"./index-BoS1faQc.js";import"./vendor-editor-B9lhLLQS.js";import"./vendor-react-DPuOgitA.js";import"./vendor-utils-ByAAln5b.js";const y="#003768",v="#12b6f3",e=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");function m(t,o){return`
  ...
  </div>`}const b=t=>t===!0?'<span style="color:#15803d;font-weight:700;">Yes</span>':t===!1?'<span style="color:#b91c1c;font-weight:700;">No</span>':'<span style="color:#94a3b8;">—</span>',c=t=>"৳"+Number(t||0).toLocaleString();async function w(t,o){const{default:p}=await $(async()=>{const{default:i}=await import("./html2pdf-BmLNKVOg.js").then(a=>a.h);return{default:i}},__vite__mapDeps([0,1])),d=document.createElement("div");return d.innerHTML=t,p().set({margin:[12,12,14,12],filename:o,image:{type:"jpeg",quality:.95},html2canvas:{scale:2,useCORS:!0},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"}}).from(d).outputPdf("blob")}async function P({receipt:t={},tenancy:o={},property:p={}}){const d=new Date().toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}),i=t.status==="paid",a=!i&&Number(t.amount_paid)>0,l=i?{t:"PAID",c:"#15803d",bg:"#dcfce7"}:a?{t:"PARTIAL",c:"#b45309",bg:"#fef3c7"}:{t:"DUE",c:"#b91c1c",bg:"#fee2e2"},f=(h,s,r={})=>`<tr><td style="padding:7px 10px;border:1px solid #e2e8f0;${r.b?"font-weight:700;":""}${r.c?`color:${r.c};`:""}">${h}</td><td style="padding:7px 10px;border:1px solid #e2e8f0;text-align:right;${r.b?"font-weight:700;":""}${r.c?`color:${r.c};`:""}">${c(s)}</td></tr>`,g=o.tenant?.full_name||"",x=`
