...
import { getServiceBySlug, SERVICES, SERVICE_HERO_CONFIG } from "../data/servicesData";
...
export default function ServiceDetailPage({ onOpenAppraisal }) {
  ...
  if (!service) {
    return (
      <div className="pt-32 pb-20 max-w-4xl mx-auto px-4 text-center space-y-4">
        <h2 className="text-2xl font-bold text-[#012a4e]">Service Not Found</h2>
        <p className="text-sm text-slate-500">
          The requested service &ldquo;{slug}&rdquo; could not be located.
        </p>
        <Link
          to="/services"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-xs font-bold text-white bg-[#00AEEF] hover:bg-[#0096ce]"
        >
  ...
  return (
    <div className="bg-white text-[#012a4e] min-h-screen">
      ...
      <div className="sticky top-16 sm:top-20 z-30 border-y border-slate-200 bg-white/95 backdrop-blur-md shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between text-xs font-semibold">
          <div className="flex items-center gap-2 overflow-x-auto whitespace-nowrap">
            <Link to="/" className="text-slate-500 hover:text-[#012a4e] transition">
              Home
            </Link>
      ...
      <section id="overview" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 scroll-mt-24">
      ...
      {/* ── ENGAGEMENT OPTIONS & COVERAGE ─────────────────────────── */}
      <section id="options" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 scroll-mt-24">
